...
class Pass1Assembler:
    ...
    def run(self):
        ...
        for line in self.source_file:
            ...
            # print(f"DEBUG: Parsed line: {line}")  # Debug statement
            ...
            if line.mnemonic in ['LTORG', 'END']:
                ...
                if line.mnemonic == 'END':
                    ...
                    break    # program following END is DATA Section
                continue

            # --- 3. Symbol Handling ---
            if line.label:
                res = self._insert_symbol(line.label)
                print(f"DEBUG: Inserting symbol '{line.label}' at {hex(current_loc)} with result {res}")  # Debug statement
                if res == 0:
